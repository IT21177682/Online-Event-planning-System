...
<center>
	...
	<center><h1>UPDATE EVENT PACKAGE </h1></center>
	<table>
	<tr>
			<td>Package ID</td>
		...
		<tr>
			<td>EvenetID</td>
			<td><input type="text" name="eventID" value="<%= eventID %>"></td>
		</tr>
		<tr>
			<td>Event Name</td>
	...
	<tr>
		<td>Music band</td>
		<td><input type="text" name="musicBand" value="<%=musicBand  %>"></td>
	</tr>
	<tr>
		<td>Artist 1</td>
		<td><input type="text" name="artistA" value="<%=artistA %>"></td>
	</tr>
	<tr>
		<td>Artist 2</td>
		<td><input type="text" name="artistB" value="<%=artistB  %>"></td>
	</tr>
		<tr>
			<td>Artist 3</td>
			<td><input type="text" name="artistC" value="<%=artistC  %>" ></td>
		</tr>
		<tr>
			<td>Date</td>
		...
		<tr>
		<td>Tickets</td>
		<td><input type="text" name="tickets" value="<%= tickets %>"></td>
	</tr>
